...
//        $laps = ['cpu_id' => random_int(1, 28), 'gpu_id' => random_int(1, 14), 'max_ram_id' => random_int(1, 5), 'ram_id' => random_int(1, 24), 'rom_id' => random_int(1, 18), 'os_id' => random_int(1, 5), 'screen_id' => random_int(1, 19), 'battery_id' => random_int(1, 3), 'weight_id' => random_int(1, 27), 'size_id' => random_int(1, 10), 'port_id' => random_int(1, 32)];
        for ($i=1;$i<100;$i++){
            ...
            DB::table('laptop_specs')->insert(['id'=>$i,'cpu_id' => random_int(1, 28), 'gpu_id' => random_int(1, 14), 'max_ram_id' => random_int(1, 5), 'ram_id' => random_int(1, 24), 'rom_id' => random_int(1, 18), 'os_id' => random_int(1, 5), 'screen_id' => random_int(1, 19), 'battery_id' => random_int(1, 3), 'weight_id' => random_int(1, 27), 'size_id' => random_int(1, 10), 'port_id' => random_int(1, 32)]);
        }
    }
}
